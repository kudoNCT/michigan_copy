...
def dataset_inference_dataLoad(opt,name):
    base_dir = opt.data_dir
    subset = opt.subset
    label_ref_dir = base_dir + '/' + subset + '_labels/' + name + '.png'
    label_tag_dir = base_dir + '/' + subset + '_labels/' + name + '.png'
    orient_tag_dir = base_dir + '/' + subset + '_dense_orients/' + name + '_orient_dense.png'
    orient_ref_dir = base_dir + '/' + subset + '_dense_orients/' + name + '_orient_dense.png'
    orient_mask_dir = base_dir + '/' + subset + '_labels/' + name + '.png'
    image_ref_dir = base_dir + '/' + subset + '_images/' + name + '.jpg'
    image_tag_dir = base_dir + '/' + subset + '_images/' + name + '.jpg'
